"""
Django settings for DjangoRolApp project.
...
SECRET_KEY = 'django-insecure-&@b2kenj(7pyc2mhduh7-^sm8^jcz)qz94sv%zs#-&a7urno=a'
...
ROOT_URLCONF = 'DjangoRolApp.urls'
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            BASE_DIR / "templates",
            os.path.join(BASE_DIR, 'templates'),  # Agrega esta línea si no está presente
            os.path.join(BASE_DIR, 'accounts', 'templates'),  # Agrega esta línea
        ],
...
WSGI_APPLICATION = 'DjangoRolApp.wsgi.application'
